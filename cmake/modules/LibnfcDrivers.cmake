...
SET(LIBNFC_DRIVER_PN532_NET ON CACHE BOOL "Enable PN532 NET support (Use net port)")
...
IF(LIBNFC_DRIVER_PN532_NET)
  ADD_DEFINITIONS("-DDRIVER_PN532_NET_ENABLED")
  SET(DRIVERS_SOURCES ${DRIVERS_SOURCES} "drivers/pn532_net")
  SET(NET_REQUIRED TRUE)
ENDIF(LIBNFC_DRIVER_PN532_NET)
